...
// 툴 또는 프레임워크에 특정 코드를 어떻게 해석해야하는지에 대한 정보를 제공.
// 컴파일러에게 코드 작성의 의도를 알릴 수 있음
// 실행시 특정 코드가 어떻게 동작하는지 지정할 수 있음

// @Override: 지정한 메소드가 상위 클래스의 메서드를 오버라이드 하는 메서드임을 컴파일러에게 알려주는 어노테이션
// @Depreacted: 지정한 메소드가 더 이상 사용되지 않음을 명시
...
public class H_Annotation extends Over {
	...
	@SuppressWarnings("unused")
	 public static void main(String[] args) {
		...
		CustomAnnotation.class.getDeclaredAnnotation(null);
	}
}
