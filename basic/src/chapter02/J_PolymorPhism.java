...
// 오버로딩(Overloading): 같은 클래스 내에서 동일한 이름의 메소드를 여러 개 정의할 수 있는 것
// 오버라이딩(Overriding): 자손 클래스에서 조상 클래스의 정의된 메소드를 재정의 하는 것 
...
//		People people1 = new People("최수림", 26);
...
//		업캐스팅이 되지 않은 참조변수에 대해서는 다운캐스팅 작업시 예외 발생
