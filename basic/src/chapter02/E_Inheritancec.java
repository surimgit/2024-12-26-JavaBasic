...
// 다이아몬드 문제: 다중 상속으로 인해 동일한 이름의 메서드를 상속받은 상태에서 어떤 메소드를
// 선택해야 할지 모호해지는 문제
// 인터페이스를 사ㅐ용하여 다중 상속 효과를 줄 수 있고, 중첩 상속을 이용하여 효과를 볼 수도 있음
class Firefighter extends Korean	{
	String position;
	
	// Human 클래스에서 상속받은 sleep 메소드를 오버로딩한 것
	void sleep(int time) {
...
//		오버라이딩을 통해서 코드의 재사용성을 증가 시킬 수 있음
		super.sleep();
	}
	
//	void eat() {
//		System.out.println("영원사원이 밥을 먹습니다.");
//	}
}
...
public class E_Inheritancec {
	public static void main(String[] args) {
		Firefighter firefighter = new Firefighter();
		firefighter.name = "최수림";
